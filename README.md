...
| **Category** | **Topics** |
|--------------|------------|
| **String Techniques** | Strings, Prefix Checking, Binary Strings, Subsequence Patterns, Trie (Prefix Tree), First/Last Occurrence Indexing, ASCII-Based Logic, Vowel-Consonant Balance, Alphanumeric Filtering, Palindrome Checking, Symbol Parsing, Time String Parsing, KMP Prefix Function (Longest Prefix Suffix), Z-Algorithm, Pattern Periodicity, Prefix-Suffix Overlap, String Matching, Odd Length Palindromes, Manacher's Algorithm |
